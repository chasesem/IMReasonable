...
- (void)audioRecorderDidFinishRecording:(AVAudioRecorder *)recorder successfully:(BOOL)flag {
    if (flag) {
        ...
        NSString *fileold = [path stringByAppendingPathComponent:LVRecordFielName];
        NSString *filenew = [NSString stringWithFormat:@"%@/%@/%@.caf",path,@"voice",timeString];
        [[NSFileManager  defaultManager] moveItemAtPath:fileold toPath:filenew error:nil];

        [self.delegate recordToolSendVoicePath:filenew voiceLenth:time];
