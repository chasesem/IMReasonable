...
- (NSString *)time
{
    return [[self elementForName:@"time"] stringValue];
}
- (NSString *)voicelenth
{
    return [[self elementForName:@"vl"] stringValue];
}
...
{
    NSXMLElement *timeElement = [NSXMLElement elementWithName:@"time" stringValue:time];
    [self addChild:timeElement];
}

- (void)addvoicelenth:(NSString *)voicelenth
{
    NSXMLElement *timeElement = [NSXMLElement elementWithName:@"vl" stringValue:voicelenth];
    [self addChild:timeElement];
}
